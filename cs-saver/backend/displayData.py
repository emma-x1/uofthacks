...
mock_data = {"entry1": {"date": "01-18-2025 7:02", "temperature": 36.8, "humidity": 52, "title":"studying for exam", "event": "have a math final on Tuesday, very worried about learning linear algebra."},
